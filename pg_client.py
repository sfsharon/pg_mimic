...
""" 
PBI_PREVIEW_TABLE_CONTENTS_MSG_5 Contains :
Simple Query (Q message) : "DISCARD ALL"
PBDE Query :
        select "$Table"."xint" as "xint",
            "$Table"."xtext" as "xtext"
        from "public"."test1" "$Table"
        limit 1000
"""
PBI_PREVIEW_TABLE_CONTENTS_MSG_5 = \
                b"\x51\x00\x00\x00" \
                b"\x10\x44\x49\x53\x43\x41\x52\x44\x20\x41\x4c\x4c\x00\x50\x00\x00" \
                b"\x00\x76\x00\x73\x65\x6c\x65\x63\x74\x20\x22\x24\x54\x61\x62\x6c" \
                b"\x65\x22\x2e\x22\x78\x69\x6e\x74\x22\x20\x61\x73\x20\x22\x78\x69" \
                b"\x6e\x74\x22\x2c\x0d\x0a\x20\x20\x20\x20\x22\x24\x54\x61\x62\x6c" \
                b"\x65\x22\x2e\x22\x78\x74\x65\x78\x74\x22\x20\x61\x73\x20\x22\x78" \
                b"\x74\x65\x78\x74\x22\x0d\x0a\x66\x72\x6f\x6d\x20\x22\x70\x75\x62" \
                b"\x6c\x69\x63\x22\x2e\x22\x74\x65\x73\x74\x31\x22\x20\x22\x24\x54" \
                b"\x61\x62\x6c\x65\x22\x0d\x0a\x6c\x69\x6d\x69\x74\x20\x31\x30\x30" \
                b"\x30\x00\x00\x00\x42\x00\x00\x00\x0e\x00\x00\x00\x00\x00\x00\x00" \
                b"\x01\x00\x01\x44\x00\x00\x00\x06\x50\x00\x45\x00\x00\x00\x09\x00" \
                b"\x00\x00\x00\x00\x53\x00\x00\x00\x04"
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        for msg in msgs :
            ...
            if msg == PBI_STARTUP_PBDE_x3_S :
                ...
                rx_iterations = 2
            elif msg == PBI_PREVIEW_TABLE_CONTENTS_MSG_5 :
                print ("Sending PBI_PREVIEW_TABLE_CONTENTS_MSG_5. Looking for two return messages")
                rx_iterations = 2
